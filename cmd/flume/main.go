...
import (
	...
	"github.com/stockyard-dev/stockyard-flume/internal/license"
...
func main() {
	...
	licenseKey := os.Getenv("FLUME_LICENSE_KEY")
	...
	log.Printf("Stockyard Flume listening on :%s (tier: %s)", port, tier)
